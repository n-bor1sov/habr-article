...
- Так как метрики ретрива основывались на попавших в контекст документах, и не учитывали сущности. Метрики генерации были воспроизведены, несмотря на отставание по метрикам ретрива.
